...
describe('AddressInfo', function() {
  ...
  describe('instantiation', function() {
    ...
    var data = require('./sampleAddressFromExplorer.json');
    var addressInfo = AddressInfo.fromExplorer(data);


    it('works with both strings and objects', function() {
      AddressInfo.fromExplorer(JSON.stringify(data)).should.deep.equal(addressInfo);
    });

    it('parses correctly a sample response on Explorer for address mmvP3mTe53qxHdPqXEvdu8WdC7GfQ2vmx5', function() {
